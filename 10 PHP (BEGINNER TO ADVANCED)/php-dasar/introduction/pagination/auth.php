...
function upload()
{
  ...
  move_uploaded_file($tmp_name, "img/books/" . "$nama_file_baru");
...
$jumlah_data = count(query("SELECT * FROM daftarbuku"));
$jumlah_halaman = ceil($jumlah_data / $jumlah_data_perhalaman);
$halaman_aktif = (isset($_GET["halaman"])) ? $_GET["halaman"] : 1;
$data_awal = ($jumlah_data_perhalaman * $halaman_aktif) - $jumlah_data_perhalaman;
